...
public class ProdutoController {
	...
	public ResponseEntity<List<Produto>> getByNomeFabricante(@PathVariable String nome,
			@PathVariable String fabricante) {
		return ResponseEntity.ok(
				produtoRepository.findAllByNomeContainingIgnoreCaseAndFabricanteContainingIgnoreCase(nome, fabricante));
	...
	public ResponseEntity<List<Produto>> getByNomeOuFabricante(@PathVariable String nome,
			@PathVariable String fabricante) {
		return ResponseEntity.ok(
				produtoRepository.findAllByNomeContainingIgnoreCaseOrFabricanteContainingIgnoreCase(nome, fabricante));
	}
